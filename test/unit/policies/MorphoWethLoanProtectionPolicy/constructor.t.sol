...
contract ConstructorTest is MorphoWethLoanProtectionPolicyTestBase {
    ...
    function test_reverts_whenWethNotContract() public {
        ...
        new MorphoWethLoanProtectionPolicy(address(policyManager), owner, address(morpho), address(0), 0.95e18);
    }
    ...
    function test_reverts_whenMorphoNotContract() public {
        ...
        new MorphoWethLoanProtectionPolicy(address(policyManager), owner, address(0), address(wethToken), 0.95e18);
    }
    ...
    function test_storesMorphoImmutable(address morphoAddr) public {
        ...
        MorphoWethLoanProtectionPolicy p =
            new MorphoWethLoanProtectionPolicy(address(policyManager), owner, morphoAddr, address(wethToken), 0.95e18);
